...
const users = [
  ...
  },
  {
    ...
    // Extra demo clients (to avoid repeated names in seeded schedules)
  {
    id: 'user14',
    name: 'Miguel Santos',
    phone: '+351 911 100 014',
    image: placeholder,
    password: 'demo123',
    role: 'user',
    appointments: [],
